...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AArcanoidGameModeBase_Statics::NewProp_Paddle_MetaData[] = {
		{ "Comment", "//The Inventory of this Actor\n" },
		{ "ModuleRelativePath", "ArcanoidGameModeBase.h" },
		{ "ToolTip", "The Inventory of this Actor" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AArcanoidGameModeBase_Statics::NewProp_Paddle = { "Paddle", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AArcanoidGameModeBase, Paddle), Z_Construct_UClass_APaddle_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AArcanoidGameModeBase_Statics::NewProp_Paddle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AArcanoidGameModeBase_Statics::NewProp_Paddle_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AArcanoidGameModeBase_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AArcanoidGameModeBase_Statics::NewProp_Paddle,
	};
	...
	IMPLEMENT_CLASS(AArcanoidGameModeBase, 2437391415);
